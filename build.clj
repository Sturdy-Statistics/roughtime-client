...
(def lib 'com.sturdystats/roughtime-client)
...
(defn jar
  ...
  (b/write-pom
   {:class-dir class-dir
    ...
    :src-dirs  ["src"]
    :pom-data
    [[:description "Clojure implementation of a simple RoughTime CLI client."]
     [:url "https://github.com/Sturdy-Statistics/roughtime-client"]
     [:licenses
      [:license
     ...
     [:scm
      ...
      [:url "https://github.com/Sturdy-Statistics/roughtime-client"]
      [:connection "scm:git:https://github.com/Sturdy-Statistics/roughtime-client.git"]]]})
